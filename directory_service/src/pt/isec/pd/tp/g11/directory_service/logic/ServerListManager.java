...
public class ServerListManager extends Thread {
    ...
    // A lista está ordenada por ordem de registo
    ...
    public synchronized UDPMessage processRequest(UDPMessage message, InetAddress senderAddress) {
        if (message == null || message.getType() == null) {
            return new UDPMessage(MessageType.ERROR, "INVALID_MESSAGE_OBJECT");
        }
        ...
        switch (command) {
            ...
            case SERVER_HEARTBEAT: // Registar e Heartbeat fazem o mesmo
     ...
     */
    private UDPMessage getPrimaryServerInfo() {
        // O acesso à lista é sincronizado pelo 'synchronized' no processRequest
